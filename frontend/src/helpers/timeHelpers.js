...
export const testData = [
    {from: DateTime.local(2017, 5, 15, 8, 30).toString(), to: DateTime.local(2017, 5, 15, 12, 30).toString(), project: 'Test Project', role: 'DEV', description: 'test Description'},
    ...
    {from: DateTime.local(2019, 6, 15, 13, 30).toString(), to: DateTime.local(2019, 6, 15, 16, 30).toString(), project: 'Test Project', role: 'DEV', description: 'test Description'}
]
